...
FillDB = DB_insert_from_excel(xl_Products="Monitors_Model_Base_2021_09-1.xlsx",
                      xl_Vardata="Allgid monitors september 2021 ed1.xlsx", #Менять месяцы на правильные согласно ctaiegoris_fields.json
                     Category="Mnt",
