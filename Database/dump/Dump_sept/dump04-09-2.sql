...
-- -----------------------------------------------------
-- Table `all_gid_2`.`mfp_classes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `all_gid_2`.`mfp_classes` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `all_gid_2`.`mfp_products`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `all_gid_2`.`mfp_products` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `brand` VARCHAR(45) NULL DEFAULT NULL,
  `name` VARCHAR(45) NULL DEFAULT NULL,
  `type` VARCHAR(45) NULL DEFAULT NULL,
  `prt_technology` VARCHAR(45) NULL DEFAULT NULL,
  `color` VARCHAR(45) NULL DEFAULT NULL,
  `format_a` VARCHAR(45) NULL DEFAULT NULL,
  `fax` ENUM('Да', 'Нет') NULL DEFAULT NULL,
  `duplex` ENUM('Да', 'Нет') NULL DEFAULT NULL,
  `photo` ENUM('Да', 'Нет') NULL DEFAULT NULL,
  `usb` ENUM('Да', 'Нет') NULL DEFAULT NULL,
  `wi_fi` ENUM('Да', 'Нет') NULL DEFAULT NULL,
  `ethernet` ENUM('Да', 'Нет') NULL DEFAULT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
AUTO_INCREMENT = 5088
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `all_gid_2`.`mfp_products_has_mfp_classes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `all_gid_2`.`mfp_products_has_mfp_classes` (
  `fk_products` INT(11) NOT NULL AUTO_INCREMENT,
  `fk_classes` INT(11) NOT NULL,
  INDEX `fk_Mfp_products_has_Mfp_classes_Nb_products1_idx` (`fk_products` ASC) VISIBLE,
  INDEX `fk_classes_idx` (`fk_classes` ASC) VISIBLE,
  CONSTRAINT `fk_mfp_classes0`
    FOREIGN KEY (`fk_classes`)
    REFERENCES `all_gid_2`.`mfp_classes` (`id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_mfp_products0`
    FOREIGN KEY (`fk_products`)
    REFERENCES `all_gid_2`.`mfp_products` (`id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 5088
...
-- -----------------------------------------------------
-- Table `all_gid_2`.`mfp_vardata`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `all_gid_2`.`mfp_vardata` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_Mfp_products_vardata_idx` (`fk_products` ASC) VISIBLE,
  CONSTRAINT `fk_Mfp_products_vardata0`
    FOREIGN KEY (`fk_products`)
    REFERENCES `all_gid_2`.`mfp_products` (`id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `all_gid_2`.`mnt_products` (
  ...
  `resolution_abb` VARCHAR(45) NULL DEFAULT NULL,
  `matrix_type` VARCHAR(45) NULL DEFAULT NULL,
  `curved` VARCHAR(45) NULL DEFAULT NULL,
  `game` VARCHAR(45) NULL DEFAULT NULL,
  `response_time` VARCHAR(45) NULL DEFAULT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
AUTO_INCREMENT = 1589
DEFAULT CHARACTER SET = utf8;
