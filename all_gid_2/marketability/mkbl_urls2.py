...
from . import views, views_new, views_new2, txt_views_new
...
urlpatterns = [
    ...
    path('<slug:cat_>/', views_new2.page_Category_Main, name='cat'),
    path('<slug:cat_>/<slug:product_>', views_new2.page_new_Product, name='product'),
