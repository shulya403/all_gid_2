...
__all__ = [ 'OLE_YPOS_CONTAINER', 'OLE_CANCELBOOL', 'FONTSIZE',
           'OLE_YSIZE_PIXELS', 'Checked', 'FONTSTRIKETHROUGH',
           'IFontDisp', 'OLE_YPOS_HIMETRIC', 'OLE_HANDLE',
           'FontEvents', 'OLE_XSIZE_HIMETRIC', 'FONTITALIC',
           'IFontEventsDisp', 'FONTBOLD', 'OLE_XPOS_HIMETRIC',
           'Unchecked', 'OLE_XSIZE_PIXELS', 'Default', 'OLE_COLOR',
           'OLE_XSIZE_CONTAINER', 'FONTNAME', 'Font', 'OLE_TRISTATE',
           'LoadPictureConstants', 'IFont', 'OLE_ENABLEDEFAULTBOOL',
           'OLE_XPOS_CONTAINER', 'StdFont', 'Gray',
           'OLE_YSIZE_HIMETRIC', 'Color', 'OLE_YSIZE_CONTAINER',
           'StdPicture', 'VgaColor', 'Monochrome', 'OLE_XPOS_PIXELS',
           'IPictureDisp', 'OLE_YPOS_PIXELS', 'Picture',
           'FONTUNDERSCORE', 'OLE_OPTEXCLUSIVE', 'IPicture']
from comtypes import _check_version; _check_version('1.1.11', 1247529555.8774643)
